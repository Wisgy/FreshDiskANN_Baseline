...
tsl::robin_set<TagT> random_tags(size_t num, size_t upper = 1000000) {
  if (num > upper) {
    std::cerr << "The number of changing points should be less than " << upper
              << std::endl;
    exit(0);
  }
...
void unit_test() {
  std::string data_path = "/DiskANN/build/data/sift/sift_learn.fbin";
  std::string index_file = "/DiskANN/build/data/sift/disk_sift_disk.index";
  std::string truthset_file = "/DiskANN/build/data/sift/sift_query_learn_gt100";
  std::string query_file = "/DiskANN/build/data/sift/sift_query.fbin";
  std::string save_path = "/DiskANN/build/data/sift/disk";
  //
  // FIXME:summary parameters
  diskann::Parameters paras;
...
#else
./tests/overall_performance float ../../main_DiskANN/DiskANN/build/data/sift/sift_learn.fbin 50 32 1.2 50 32 1.2 50000 10000 500 10000 ../../main_DiskANN/DiskANN/build/data/ true false ../../main_DiskANN/DiskANN/build/data/sift/sift_learn.fbin ../../main_DiskANN/DiskANN/build/data/sift/sift_query.fbin ../../main_DiskANN/DiskANN/build/data/sift/sift_query_learn_gt100 10 20 5 1000
#endif